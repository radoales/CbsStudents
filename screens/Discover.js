...
const Discover = props => {
   ...
   return (
      <View>
         ...
         <View style={[styles.block, { backgroundColor: 'rgba(rgb(128,0,128),0.8)', alignItems: 'center' }]}>
            <Text style={styles.text}>ALL EVENTS</Text>
         </View>
         <View style={[styles.block, { backgroundColor: 'rgba(72,61,139,0.8)', alignItems: 'center' }]}>
            <Text style={styles.text}>ALL STUDENT ORGANIZATIONS</Text>
         </View>
         <View style={[styles.block, { backgroundColor: 'rgba(32,178,170, 0.8)', alignItems: 'center' }]}>
