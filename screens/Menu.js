...
const Menu = () => {
   ...
   const toggleSwitchChat = () => setIsChatEnabled(previousState => !previousState);

   const [isEventEnabled, setIsEventEnabled] = React.useState(false);
   const toggleSwitchEvent = () => setIsEventEnabled(previousState => !previousState);
   ...
   return (
      <View style={{flexDirection: 'column'}}>
         ...
         <View style={styles.settingsBox}>
            <View style={{ flexDirection: 'row' }}>
               <View style={{ flex: 5, flexDirection: 'column', paddingLeft: 10 }}>
                  <Text style={{ fontWeight: 'bold', fontSize: 15, paddingTop: 10 }}>Chat</Text>
                  <Text style={styles.notificationText}>When you receive a new message</Text>
               </View>
         ...
         <View style={styles.settingsBox}>
            <View style={{ flexDirection: 'row' }}>
               <View style={{ flex: 5, flexDirection: 'column', paddingLeft: 10 }}>
                  <Text style={{ fontWeight: 'bold', fontSize: 15, paddingTop: 10 }}>Event Reminder</Text>
                  <Text style={styles.notificationText}>An hour before events you are 'going to'</Text>
               </View>
               <View style={{ flex: 1, flexDirection: 'column', }}>
                  <Switch
                     style={{ paddingVertical: 15 }}
