...
export const CHATMESSAGES_SURF = [
    new ChatMessage('1', new Date(2020, 0, 20, 11, 36, 23), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', USERS[0], false),
    new ChatMessage('2', new Date(2020, 0, 17, 20, 12, 1), 'Lorem ipsum dolor sit amet, consectetur ', USERS[1], true),
    new ChatMessage('25', new Date(2020, 0, 17, 20, 12, 1), 'Lorem ipsum', USERS[1], true),
...
export const CHATMESSAGES_FEM = [
    new ChatMessage('5', new Date(2021, 4, 19, 20, 10, 1), 'Thank you for your message!', USERS[0], true),
...
export const CHATMESSAGES_GOLF = [
    new ChatMessage('13', new Date(2021, 3, 21, 20, 10, 1), 'Thank you for your message!', USERS[0], false),
...
export const CHATMESSAGES_PRVT = [
    new ChatMessage('21', new Date(2020, 11, 7, 20, 10, 1), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit', USERS[1], true),
    new ChatMessage('22', new Date(2020, 11, 3, 20, 12, 1), 'Hello I am here', USERS[0], true),
    new ChatMessage('23', new Date(2020, 10, 18, 20, 14, 1), 'Hello how are you!', USERS[1], true),
    new ChatMessage('24', new Date(2021, 2, 20, 20, 15, 1), 'Hello looking at a React Native teacher right now..!', USERS[0], true),
];
...
export const CHATROOM_PRVT = [
    new ChatRoom('6', new Date(2021, 0, 1, 2, 0, 0), 'Lara Thayer', CHATMESSAGES_PRVT, require('../assets/lara.jpg')),
    new ChatRoom('7', new Date(2021, 0, 1, 2, 1, 0), 'Alex Lee', CHATMESSAGES_PRVT, require('../assets/alex.jpg')),
    new ChatRoom('8', new Date(2021, 0, 1, 2, 2, 0), 'Felipe Grace', CHATMESSAGES_PRVT, require('../assets/felipe.jpg')),
    new ChatRoom('9', new Date(2021, 0, 1, 2, 2, 0), 'Board of directors', CHATMESSAGES_PRVT, require('../assets/cbssurf.jpg')),
];